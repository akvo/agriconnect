...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('QUEUED', 'DONE', 'FAILED', 'TIMEOUT', name='callbackstage'), nullable=True),
    ...
    op.add_column('messages', sa.Column('message_type', sa.Enum('REPLY', 'WHISPER', name='messagetype'), nullable=True))
