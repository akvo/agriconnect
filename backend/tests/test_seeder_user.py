...
class TestGetUserInput:
    ...
    @patch('builtins.input')
    @patch('getpass.getpass')
    def test_get_user_input_extension_officer_success(self, mock_getpass, mock_input):
    ...
    @patch('builtins.input')
    @patch('getpass.getpass')
    def test_get_user_input_invalid_email_retry(self, mock_getpass, mock_input):
    ...
    @patch('builtins.input')
    @patch('getpass.getpass')
    def test_get_user_input_short_password_retry(self, mock_getpass, mock_input):
    ...
    @patch('builtins.input')
    @patch('getpass.getpass')
    def test_get_user_input_password_mismatch_retry(self, mock_getpass, mock_input):
    ...
    @patch('builtins.input')
    @patch('getpass.getpass')
    def test_get_user_input_invalid_user_type_retry(self, mock_getpass, mock_input):
    ...
    def test_get_user_input_invalid_phone_retry(self, mock_validate, mock_getpass, mock_input):
...
class TestSeederIntegration:
    ...
    def test_seeder_with_existing_users(self, db_session):
        ...
        users = db_session.query(User).filter(User.email.like(f"%{unique_id}%")).all()
        assert len(users) == 1
