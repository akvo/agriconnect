...
from schemas.user import UserCreate, UserResponse, LoginRequest, TokenResponse, SelfUpdateRequest, AcceptInvitationRequest, InvitationStatusResponse
...
@router.get("/verify-invitation/{invitation_token}", response_model=InvitationStatusResponse)
...
def accept_invitation(
    ...
    user = UserService.accept_invitation(db, request.invitation_token, request.password)
