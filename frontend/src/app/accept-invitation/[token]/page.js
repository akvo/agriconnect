...
export default function AcceptInvitationPage() {
  ...
  if (error || !invitationStatus?.valid) {
    const errorMessage =
      error || invitationStatus?.error_message || "Invalid invitation";
        ...
        <div className="w-full max-w-[36rem] relative z-10">
          ...
          >
            ...
            {isExpired && (
              ...
              >
                <p className="text-sm">
                  <strong>Need a new invitation?</strong>
                  <br />
                  Please contact your administrator to resend your invitation
                  link.
                </p>
              </div>
            )}
      ...
      <div className="w-full max-w-[36rem] relative z-10">
        ...
        {invitationStatus?.user_info && (
          ...
          >
            ...
            <p className="text-sm">
              <strong>{invitationStatus.user_info.full_name}</strong>
              <br />
              {invitationStatus.user_info.email} •{" "}
              {invitationStatus.user_info.user_type === "admin"
                ? "Administrator"
                : "Extension Officer"}
            </p>
          </div>
